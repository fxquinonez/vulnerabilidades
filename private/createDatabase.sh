...
insert into players values (5, 'Iouga <script type="text/javascript"> console.log("XSS test"); </script>', "Benchmasters");
...
insert into comments values (9, 5,9, 'I do like him, he has some potential. <script type="text/javascript"> alert("XSS test"); </script>');
